        ...
        <b-card>
            <b-row>
                ...
                <b-col sm="7" class="d-none d-md-block">
                    <b-button type="button" variant="primary" class="float-right"><i class="icon-cloud-download"></i>
                    </b-button>
                    <b-button-toolbar class="float-right" aria-label="Toolbar with buttons group">
                        <b-form-radio-group class="mr-3" id="radiosBtn" buttons button-variant="outline-secondary"
                                            v-model="selected" name="radiosBtn">
            ...
            <main-chart-example class="chart-wrapper" style="height:300px;margin-top:40px;"
                                height="300"></main-chart-example>
            <div slot="footer">
                <ul>
                    <li>
                        <div class="text-muted">Visits</div>
                        <strong>29.703 Users (40%)</strong>
                        <b-progress height={} class="progress-xs mt-2" :precision="1" variant="success"
                                    :value="40"></b-progress>
                    </li>
                    <li class="d-none d-md-table-cell">
                        <div class="text-muted">Unique</div>
                        <strong>24.093 Users (20%)</strong>
                        <b-progress height={} class="progress-xs mt-2" :precision="1" variant="info"
                                    :value="20"></b-progress>
                    </li>
                    <li>
                        <div class="text-muted">Pageviews</div>
                        <strong>78.706 Views (60%)</strong>
                        <b-progress height={} class="progress-xs mt-2" :precision="1" variant="warning"
                                    :value="60"></b-progress>
                    </li>
                    <li class="d-none d-md-table-cell">
                        <div class="text-muted">New Users</div>
                        <strong>22.123 Users (80%)</strong>
                        <b-progress height={} class="progress-xs mt-2" :precision="1" variant="danger"
                                    :value="80"></b-progress>
                    </li>
                    <li class="d-none d-md-table-cell">
        ...
        <b-row>
            <b-col md="12">
                <b-card header="Traffic &amp; Sales">
                        ...
                        <b-col sm="12" lg="4">
                            <b-row>
                                <b-col sm="6">
                                    <Callout variant="info">
                                        ...
                                        <div class="chart-wrapper">
                                            <callout-chart-example :data="[35, 23, 56, 22, 97, 23, 64]"
                                                                   variant="#20a8d8" width="80" height="30"/>
                                        </div>
                                    </Callout>
                                </b-col>
                                <b-col sm="6">
                                    <Callout variant="danger">
                                        ...
                                        <div class="chart-wrapper">
                                            <callout-chart-example :data="[65, 59, 84, 84, 51, 55, 40]"
                                                                   variant="#f86c6b" width="80" height="30"/>
                                        </div>
                                    </Callout>
                                </b-col>
                            </b-row>
                            ...
                            <ul class="horizontal-bars">
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="34"
                                                    variant="info"></b-progress>
                                        <b-progress height={} class="progress-xs" :value="78"
                                ...
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="56"
                                                    variant="info"></b-progress>
                                        <b-progress height={} class="progress-xs" :value="94"
                                                    variant="danger"></b-progress>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="12"
                                                    variant="info"></b-progress>
                                        <b-progress height={} class="progress-xs" :value="67"
                                                    variant="danger"></b-progress>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="43"
                                                    variant="info"></b-progress>
                                        <b-progress height={} class="progress-xs" :value="91"
                                                    variant="danger"></b-progress>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="22"
                                                    variant="info"></b-progress>
                                        <b-progress height={} class="progress-xs" :value="73"
                                                    variant="danger"></b-progress>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="53"
                                                    variant="info"></b-progress>
                                        <b-progress height={} class="progress-xs" :value="82"
                                                    variant="danger"></b-progress>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="9"
                                                    variant="info"></b-progress>
                                        <b-progress height={} class="progress-xs" :value="69"
                                                    variant="danger"></b-progress>
                                    </div>
                                </li>
                                <li class="legend">
                        ...
                        <b-col sm="6" lg="4">
                            <b-row>
                                <b-col sm="6">
                                    <Callout variant="warning">
                                        ...
                                        <div class="chart-wrapper">
                                            <callout-chart-example :data="[35, 23, 56, 22, 97, 23, 64]"
                                                                   variant="#f8cb00" width="80" height="30"/>
                                        </div>
                                    </Callout>
                                </b-col>
                                <b-col sm="6">
                                    <Callout variant="success">
                                        ...
                                        <div class="chart-wrapper">
                                            <callout-chart-example :data="[65, 59, 84, 84, 51, 55, 40]"
                                                                   variant="#4dbd74" width="80px" height="30"/>
                                        </div>
                                    </Callout>
                                </b-col>
                            </b-row>
                            ...
                            <ul class="horizontal-bars type-2">
                                ...
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="37"
                                                    variant="warning"></b-progress>
                                    </div>
                                </li>
                                <li class="divider"></li>
                                ...
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="15"
                                                    variant="success"></b-progress>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="11"
                                                    variant="success"></b-progress>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="bars">
                                        <b-progress height={} class="progress-xs" :value="8"
                                                    variant="success"></b-progress>
                                    </div>
                                </li>
                                <li class="divider text-center">
                                    <b-button variant="link" size="sm" class="text-muted"><i class="icon-options"></i>
                                    </b-button>
                                </li>
                            </ul>
                        </b-col>
                        <b-col sm="6" lg="4">
                            <b-row>
                                <b-col sm="6">
                                    <Callout>
                                        ...
                                        <div class="chart-wrapper">
                                            <callout-chart-example :data="[78, 81, 80, 45, 34, 12, 40]" width="80px"
                                                                   height="30"/>
                                        </div>
                                    </Callout>
                                </b-col>
                                <b-col sm="6">
                                    <Callout variant="primary">
                                        ...
                                        <div class="chart-wrapper">
                                            <callout-chart-example :data="[35, 23, 56, 22, 97, 23, 64]"
                                                                   variant="#20a8d8" width="80px" height="30"/>
                                        </div>
                                    </Callout>
                                </b-col>
                            </b-row>
                            ...
                            <ul class="icons-list">
                                <li>
                                    ...
                                    <div class="actions">
                                        <b-button variant="link" class="text-muted"><i class="icon-settings"></i>
                                        </b-button>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li class="divider text-center">
                                    <b-button size="sm" variant="link" class="text-muted"><i class="icon-options"></i>
                                    </b-button>
                                </li>
                            </ul>
                        </b-col>
                    ...
                    <br/>
                    <b-table class="mb-0 table-outline" responsive="sm" hover :items="tableItems" :fields="tableFields"
                             head-variant="light">
                ...
                <span>
                  ...
                  <template v-else>Recurring</template>
                        ...
                        <i slot="country" class="h4 mb-0" :class="flag(item.value.flag)" slot-scope="item"
                           :title="item.value.flag" :id="item.value.flag"></i>
                        ...
                        <div slot="usage" slot-scope="item">
                            ...
                            <b-progress height={} class="progress-xs" v-model="item.value.value"
